...
<div>
    <link href="./cnet-instructor-page.css" rel="stylesheet" />

    <div class="cnet-instructor-page-container">
        <div class="cnet-instructor-page-backgroundgradientlight">
            <h1 class="cnet-instructor-page-title1">
                <span class="cnet-instructor-page-text">Instructors</span>
                <br />
            </h1>
            <div class="cnet-instructor-page-container1">

                <button type="button" class="cnet-instructor-page-cs-button button">
                    <a href="/instructors?department=cs">
                        <span class="cnet-instructor-page-text02">
                    <span>CS</span>
                    <br />
                    </span>
                    </a>
                ...
                <button type="button" class="cnet-instructor-page-cnet-button button">
                    <span class="cnet-instructor-page-text05">
                    <span>CNET</span>
                    <br />
                    </span>
                </button>

                <button type="button" class="cnet-instructor-page-it-button button">
                    <a href="/instructors?department=it">
                        <span class="cnet-instructor-page-text08">
                        <span>IT</span>
                        <br />
                        </span>
                    </a>
            ...
            <div class="cnet-instructor-page-container2">
                ...
                <div class="cnet-instructor-page-instructor-container">
                    <a href="/instructor?id=<%=instructor.getInstructorID()%>">
                        ...
                        <span class="cnet-instructor-page-text14">
        ...
        <div class="cnet-instructor-page-bottombars">
            <div class="cnet-instructor-page-bottomnavcustom">
                <div class="cnet-instructor-page-navigationbar">
                    <div class="cnet-instructor-page-home-button">
                        <a href="/">
                            <img
                                    alt="image"
                                    src="public/external/page%20icon%205.svg"
                                    class="cnet-instructor-page-image08"
                            />
                        </a>
                    </div>
                    <div class="cnet-instructor-page-instructor-button">
                        <img
                                alt="image"
                                src="public/external/page%20icon%204.svg"
                                class="cnet-instructor-page-image09"
                        />
                    </div>
                    <div class="cnet-instructor-page-contact-button">
                        <a href="/contact">
                            <img
                                    alt="image"
                                    src="public/external/page%20icon%203.svg"
                                    class="cnet-instructor-page-image10"
                            />
                        </a>
                    </div>
                </div>
